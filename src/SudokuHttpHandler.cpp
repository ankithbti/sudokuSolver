...
void SudokuHttpHandler::handleGetRequest(httpServer::HttpRequest::ConstSmartPtr req, httpServer::HttpReply::SmartPtr rep)
{
    ...
    }else if(request_path.find("/fillBox") != std::string::npos){
...
void SudokuHttpHandler::handlePostRequest(httpServer::HttpRequest::ConstSmartPtr req, httpServer::HttpReply::SmartPtr rep)
{

}

void SudokuHttpHandler::handlePutRequest(httpServer::HttpRequest::ConstSmartPtr req, httpServer::HttpReply::SmartPtr rep)
{

}

void SudokuHttpHandler::handleDeleteRequest(httpServer::HttpRequest::ConstSmartPtr req, httpServer::HttpReply::SmartPtr rep)
{
